...
-->
    ...
    <div id="header">
      ...
      <div class="nav-buttons-cont">
        <a href="logout.php"><div class="nav-button nav-button-sl">Logout</div></a>
        <div class="nav-button nav-button-about">About <i class="fas fa-user-tie"></i>
          <div class="about-buttons-cont">
            ...
            <!--  -->
            <!--  -->
            <a href="./team.php"><div class="about-button">
              <div class="about-button-icon-cont">
                <div class="about-button-icon">
        ...
        <a href="./events.php"><div class="nav-button">Events <i class="fas fa-calendar"></i></div></a>
        <a onclick="document.getElementById('id99').style.display='block'" style="width:auto;"><div class="nav-button">Add Admin <i class="fas fa-user"></i></div></a> <!-- Add Admin-->
         <a onclick="document.getElementById('id100').style.display='block'" style="width:auto;"><div class="nav-button">Add Event <i class="fas fa-plus"></i></div></a> <!-- Add event-->
      </div>
...
<div class="sidebar" id="sidebar">
  <div class="nav-sidebar-buttons">
    <a href="login.php"><div class="nav-sidebar-button">login <i class="fas fa-user-plus"></i> </div></a>
    <a href="./"><div class="nav-sidebar-button">Home<i class="fas fa-home"></i> </div></a>
    <a href="./team.php"><div class="nav-sidebar-button">Meet The Team <i class="fas fa-users"></i> </div></a>
    <a href="./about.php"><div class="nav-sidebar-button">About The Club <i class="fas fa-info-circle"></i> </div></a>
    <a href="./events.php"><div class="nav-sidebar-button">Our Events <i class="fas fa-calendar"></i> </div></a>
  </div>
...
window.onclick = function(event) {
    ...
    <div class="container">
     <center><h1><h3>Add New Admin</h3></h1></center> 
...
<div id="id100" class="modal">
  <form class="modal-content animate" method="POST" action="addEvent.php">
    <div class="imgcontainer">
      <script>
...
window.onclick = function(event) {
    ...
    <div class="container">
     <center><h1><b><h3>Add New Event</h3></b></h1></center>
